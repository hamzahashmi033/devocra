...
import thumbone from "public/images/agency/devocra.png";
import thumbtwo from "public/images/agency/devocra.png";
          ...
          <div className="col-12 col-lg-12">
            <div className="agency__content section__content">
              ...
              <h2 className="title title-anim">
                We provide a wide range of technological services to clients worldwide.
              </h2>
              ...
              <div className="skill-bar-single">
                  <div className="skill-bar-title">
                    <p className="primary-text">Website Development</p>
                  </div>
                ...
                <div className="skill-bar-single">
                  <div className="skill-bar-title">
                    <p className="primary-text">App Development</p>
                  </div>
                  <div className="skill-bar-wrapper" data-percent="100%">
                    <div className="skill-bar">
                      <div className="skill-bar-percent">
                ...
                <div className="skill-bar-single">
                  <div className="skill-bar-title">
                    <p className="primary-text">Devops Engineering</p>
                  </div>
                  <div className="skill-bar-wrapper" data-percent="100%">
                    <div className="skill-bar">
                      <div className="skill-bar-percent">
